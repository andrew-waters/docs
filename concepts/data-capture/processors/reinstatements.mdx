...
| `surface_length`       | `number`        | The length of the hole in meters
| `surface_width`        | `number`        | The width of the hole in meters
| `surface_depth`        | `number`        | The depth of the hole in millimeters
